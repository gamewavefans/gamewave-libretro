...
#include "../../src/deps/libretro-common/include/libretro.h"
#include <mpeg3/libmpeg3.h>

// std::unique_ptr<Gamewave> gamewave = std::make_unique<Gamewave>();
const char *filename = "/home/halamix2/repos/reverse/gamewave/games/Click! (USA)/movies/howtoplay.mpg";
mpeg3_t *video;
...
{
    log_cb(RETRO_LOG_DEBUG, "loading %s as a game\n", info->path);
    int *errorCode{};
    video = mpeg3_open(const_cast<char *>(filename), errorCode);
    return true;
}
